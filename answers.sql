...
Select the brand, name, and year the models brand was 
...
So, we shouldnt see models who brands arent in the brands table (a.k.a. Fillmore,
Outback) nor should we see information about brands who dont have any models in 
...
==========
13
SEE ATTACHED FILE """PROBLEMS.sql"""
Is the reason they dont match related to the fact that GTO is capital? 
==========
14
...
SELECT models.name, models.year
FROM models
